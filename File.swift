...
//  Spot
//
//  Created by Takuma Yoshida on 2015/07/12.
//  Copyright (c) 2015年 Hapiiii. All rights reserved.
//
...
public class File {
    ...
    public var dirName: String? {
        didSet {
            if dirName != nil {
                File.mkdir(directory, dirName: dirName!)
            }
        }
    }
    ...
    public var isExists: Bool {
        get {
            return File.exists(directory, path: path)
        }
    }
    ...
    public func delete() -> Bool {
        return File.rm(directory, path: self.fileName)
    }
